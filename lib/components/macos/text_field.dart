...
/// A [FormField] that contains a [MacosTextField].
///
...
///
/// For a documentation about the various parameters, see [MacosTextField].
///
/// {@tool snippet}
///
/// Creates a [TextFormField] with an [InputDecoration] and validator function.
///
/// ![If the user enters valid text, the MacosTextField appears normally without any warnings to the user](https://flutter.github.io/assets-for-api-docs/assets/material/text_form_field.png)
///
...
///  * [MacosTextField], which is the underlying text field without the [Form]
///    integration.
///  * [InputDecorator], which shows the labels and other visual elements that
///    surround the actual text editing widget.
///  * Learn how to use a [TextEditingController] in one of our [cookbook recipes](https://flutter.dev/docs/cookbook/forms/text-field-changes#2-use-a-texteditingcontroller).
class MacosTextFormField extends FormField<String> {
  /// Creates a [FormField] that contains a [MacosTextField].
  ///
  ...
  /// and [MacosTextField.new], the constructor.
  MacosTextFormField({
    super.key,
    this.controller,
    String? initialValue,
...
class _TextFormFieldState extends FormFieldState<String> {
  ...
  MacosTextFormField get _textFormField => super.widget as MacosTextFormField;
