...
Sidebar buildSidebar(BuildContext context) {
  return Sidebar(
    minWidth: 220,
    top: MacosListTile(
      leading: const Text('Project'),
      title: Center(child: Consumer(builder: (context, ref, _) {
        ...
        return projects.when(
          data: (data) {
            return currentProject.when(
                ...
                data: (current) {
                  return MacosPopupButton<Project?>(
                    value: current,
                    ...
                    items:
                        data.map<MacosPopupMenuItem<Project>>((Project value) {
                      return MacosPopupMenuItem<Project>(
                        value: value,
                        child: Text(
                          value.name ?? '--',
                        ),
